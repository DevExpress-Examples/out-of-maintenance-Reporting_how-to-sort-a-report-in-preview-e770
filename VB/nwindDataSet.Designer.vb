...
Namespace PreviewSort.nwindDataSetTableAdapters
	...
	Partial Public Class OrderDetailsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        OrderID, Quantity, UnitPrice, Discount, ProductName, Supplier" & Constants.vbCrLf & "FROM" & "            OrderDetails" & Constants.vbCrLf & "WHERE        (OrderID = :ordID)"
		...
		Public Overridable Function Fill(ByVal dataTable As nwindDataSet.OrderDetailsDataTable, ByVal ordId As Integer) As Integer
			...
			Me.Adapter.SelectCommand.Parameters(0).Value = (CInt(Fix(ordId)))
