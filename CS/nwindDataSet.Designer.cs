...
namespace PreviewSort.nwindDataSetTableAdapters {
    ...
    public partial class OrderDetailsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PreviewSort.Properties.Settings.Default.nwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        OrderID, Quantity, UnitPrice, Discount, ProductName, Supplier\r\nFROM" +
                "            OrderDetails\r\nWHERE        (OrderID = :ordID)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ordId", global::System.Data.OleDb.OleDbType.Integer, 1, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), null, global::System.Data.DataRowVersion.Current, false, null));
        }
        ...
        public virtual int Fill(nwindDataSet.OrderDetailsDataTable dataTable, int ordId) {
        ...
        public virtual nwindDataSet.OrderDetailsDataTable GetData(int ordId) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ordId));
